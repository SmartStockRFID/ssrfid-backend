...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "status", sa.Enum("INICIADA", "FINALIZADA", "CANCELADA", name="statusconferencia"), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "timestamp_leitura", sa.DateTime(timezone=True), server_default=sa.text("now()"), nullable=True
        ),
        sa.ForeignKeyConstraint(
            ["conferencia_id"],
            ["conferencia.id"],
