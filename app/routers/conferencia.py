...
@router.get("/{id_conferencia}/leituras", response_model=PaginatedResponse[LeituraOut])
def readings_from_conference(
    ...
    filters: FilterValues = Depends(create_filters_from_model(LeituraOut, exclude=["quantidade", "produto"])),
):
